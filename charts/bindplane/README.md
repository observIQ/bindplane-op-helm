...
| transform_agent_image.name | string | `""` | Image name to be used. Defaults to `ghcr.io/observiq/bindplane-transform-agent`. |
| transform_agent_image.tag | string | `""` | Image tag to use. Defaults to latest. |
