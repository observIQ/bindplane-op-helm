...
| auth.oidc | object | `{"issuer":"","oauth2ClientID":"","oauth2ClientSecret":"","oauth2ClientSecretSecret":{"key":"","name":""},"scopes":[]}` | OpenID user authentication configuration. Available with Bindplane Enterprise. |
...
| auth.oidc.oauth2ClientSecretSecret.key | string | `""` | The secret's subPath which contains the OAuth2 client secret. |
| auth.oidc.oauth2ClientSecretSecret.name | string | `""` | Kubernetes secret name that contains the OIDC OAuth2 client secret. |
