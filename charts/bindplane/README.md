...
![Version: 1.35.4](https://img.shields.io/badge/Version-1.35.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.102.0](https://img.shields.io/badge/AppVersion-1.102.0-informational?style=flat-square)
...
| auth.oidc | object | `{"issuer":"","oauth2ClientID":"","oauth2ClientSecret":"","oauth2ClientSecretRef":{"key":"","name":""},"scopes":[]}` | OpenID user authentication configuration. Available with Bindplane Enterprise. |
...
| auth.oidc.oauth2ClientSecretRef.key | string | `""` | The secret's subPath which contains the OAuth2 client secret. |
| auth.oidc.oauth2ClientSecretRef.name | string | `""` | Kubernetes secret name that contains the OIDC OAuth2 client secret. |
...
| prometheus.image.tag | string | `"v3.7.3"` | Image tag to use. |
