...
| transform_agent_image.name | string | `""` | Transform Agent Image name to be used. Defaults to `ghcr.io/observiq/bindplane-transform-agent`. |
| transform_agent_image.tag | string | `""` | Transform Agent Image tag to use. Defaults to latest. |
